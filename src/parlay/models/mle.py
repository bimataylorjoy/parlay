...
def fit_poisson_mle(
    ...
    *,
    ...
    def objective(params: np.ndarray) -> float:
        ...
        # Log-rates with clipping for numerical safety
        home_log = np.clip(mu + gamma + att[home_idx] - defense[away_idx], -5.0, 5.0)
        away_log = np.clip(mu + att[away_idx] - defense[home_idx], -5.0, 5.0)
